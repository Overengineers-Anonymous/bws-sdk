...
def test_derive_symkey():
    ...
    assert (
        key.mac_key
        == b"\"\x04m9\x19\xc1w\xa6\xdb\xea\x89\xb4u\xe1\xdf\xb2\xbbN'A\xae3\xf7\tt\xaa\xba\x95\xde(c\xe0"
    )
...
def test_from_encryption_key():
    ...
    assert (
        key.mac_key
        == b'\xe6\x85\xd7\x16\x11\r\x131"\xc9*\xd7H\x99\xdc#G\xabL\t\x12]g{\x91Hq\x16>\xae\x86u'
    )
